    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (hasHelpArg)
            {
                ...
                WriteLine("utilizando como referência os pontos cardeais em inglês: N, S, E, W.");
                WriteLine("\n[-help | /help | /?]\tExibe ajuda");
                WriteLine("\n[-file file]\t\tDefine o local do arquivo de entrada (obrigatorio). Ex: C:\\tmp\\input.txt \n");
                Environment.Exit(0);
            }
            ...
            try
            {
                ...
                WriteLine($"\nHorário de temino da execução: " + DateTime.Now.ToString());
